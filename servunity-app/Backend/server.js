...
// owner services
// app.get('/services/:owner_name', (req, res) => {
//   const { owner_name } = req.params.owner_name; // Récupérer owner_name depuis les paramètres de la requête
//   const select = 'SELECT * FROM services WHERE owner_name = ?';
//   db.query(select, [owner_name], (err, rows) => {
//     if (err) {
//       console.error('Error retrieving services:', err);
//       res.status(500).send('Error retrieving services');
//       return;
